        ...
        report: {
            ...
            form: {
                ...
                step1: {
                    ...
                    area: {
                        ...
                        options: {
                            ...
                            taxAccounting: 'Fiscal/Contabilidade',
                            legal: 'Jurídico',
                            bidding: 'Licitação',
                            hr: 'Recursos Humanos',
                            it: 'TI',
                ...
                step2: {
                    ...
                    descriptionHelp: 'É importante que seu relato seja completo e detalhado. Considere incluir:',
                    helpItems: {
                        what: 'O quê (uma descrição clara da situação ou do ocorrido)',
                        who: 'Quem (nome das pessoas envolvidas, incluindo testemunhas ou terceiros)',
                        when: 'Quando (data em que aconteceu, está acontecendo ou acontecerá)',
                        where: 'Onde (o local específico onde a situação ocorreu)',
                        why: 'Motivo (explique a causa, o contexto ou o motivo por trás da situação)',
                        how: 'Impacto (consequências, prejuízos ou efeitos causados pela situação)',
            ...
            validation: {
                ...
                descriptionMinLength: 'A descrição deve ter pelo menos 30 caracteres',
        ...
        report: {
            ...
            form: {
                ...
                step1: {
                    ...
                    violationType: {
                        ...
                        options: {
                            ...
                            threat: 'Threat',
                            financialHarassment: 'Financial harassment',
                            psychologicalHarassment: 'Psychological harassment',
                ...
                step2: {
                    ...
                    descriptionHelp: 'It’s important that your report is complete and detailed. Consider including:',
                    helpItems: {
                        what: 'What (a clear description of the situation or incident)',
                        who: 'Who (names of people involved, including witnesses or third parties)',
                        when: 'When (the date it happened, is happening, or will happen)',
                        where: 'Where (the specific location where the incident occurred)',
                        why: 'Reason (explain the root cause, context, or motivation behind the situation, if known)',
                        how: 'Impact (consequences, damages, or effects caused by the situation)',
                        evidence: 'Evidence or supporting documentation (if available, and where it can be found)'
                    }
                },
                step3: {
            ...
            validation: {
                ...
                descriptionMinLength: 'Description must have at least 30 characters',
        ...
        report: {
            ...
            form: {
                ...
                step1: {
                    ...
                    violationType: {
                        ...
                        options: {
                            ...
                            threat: 'Amenaza',
                            financialHarassment: 'Acoso financiero',
                            psychologicalHarassment: 'Acoso psicológico',
                    ...
                    area: {
                        ...
                        options: {
                            ...
                            taxAccounting: 'Impuesto/Contabilidad',
                            legal: 'Legal',
                            bidding: 'Ofertas',
                            hr: 'Recursos Humanos',
                            it: 'TI',
                ...
                step2: {
                    ...
                    descriptionHelp: 'Es importante que su informe sea completo y detallado. Considere incluir:',
                    helpItems: {
                        what: 'Qué (una descripción clara de la situación o del incidente)',
                        who: 'Quién (nombres de las personas involucradas, incluidas testigos o terceros)',
                        when: 'Cuándo (la fecha en que ocurrió, está ocurriendo o ocurrirá)',
                        where: 'Dónde (el lugar específico donde ocurrió la situación)',
                        why: 'Motivo (explique la causa, el contexto o el motivo de la situación, si se conoce)',
                        how: 'Impacto (consecuencias, daños o efectos provocados por la situación)',
                        evidence: 'Pruebas u otras evidencias (si existen y dónde se pueden encontrar)'
                    }
                },
                step3: {
            ...
            validation: {
                ...
                descriptionMinLength: 'La descripción debe tener al menos 30 caracteres',
                invalidEmail: 'E-mail inválido',
